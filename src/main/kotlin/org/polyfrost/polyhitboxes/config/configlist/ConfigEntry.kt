...
private val MINUS_ICON = SVG("/assets/minus.svg")
...
class ConfigEntry<T>(
    ...
    init {
        ...
        ConfigUtils.getSubCategory(optionPage, configListOption.category, configListOption.subcategory).options.addAll(options)
    ...
    fun drawInList(vg: Long, x: Int, y: Int, inputHandler: InputHandler) {
        ...
        nanoVGHelper.drawText(vg, configListOption.configList.getConfigName(config), (x + 64).toFloat(), (y + 17).toFloat(), WHITE_90, 14f, Fonts.MEDIUM)
